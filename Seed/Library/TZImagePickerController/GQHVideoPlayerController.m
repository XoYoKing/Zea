//
//  GQHVideoPlayerController.m
//  GQHKit
//
//  Created by GuanQinghao on 02/02/2018.
//  Copyright © 2018 GuanQinghao. All rights reserved.
//

#import "GQHVideoPlayerController.h"
...
@interface GQHVideoPlayerController ()

@end

@implementation GQHVideoPlayerController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.view.backgroundColor = [UIColor blackColor];
    GQHImagePickerController *imagePickerController = (GQHImagePickerController *)self.navigationController;
    if (imagePickerController) {
        
        self.navigationItem.title = imagePickerController;
