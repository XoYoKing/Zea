...
@interface GQHGameTableViewCell ()

@end

@implementation GQHGameTableViewCell
...
+ (instancetype)qh_tableView:(UITableView *)tableView cellWithData:(id)data {
    ...
    static NSString *identifier = @"GQHGameTableViewCell";
    GQHGameTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        
        cell = [[GQHGameTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
...
@interface GQHGameTableViewHeaderView ()

@end

@implementation GQHGameTableViewHeaderView
...
+ (instancetype)qh_tableView:(UITableView *)tableView headerViewWithData:(id)data {
    ...
    static NSString *identifier = @"GQHGameTableViewHeaderView";
    GQHGameTableViewHeaderView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:identifier];
    if (!headerView) {
        
        headerView = [[GQHGameTableViewHeaderView alloc] initWithReuseIdentifier:identifier];
    }
...
@interface GQHGameTableViewFooterView ()

@end

@implementation GQHGameTableViewFooterView
...
+ (instancetype)qh_tableView:(UITableView *)tableView footerViewWithData:(id)data {
    ...
    static NSString *identifier = @"GQHGameTableViewFooterView";
    GQHGameTableViewFooterView *footerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:identifier];
    if (!footerView) {
        
        footerView = [[GQHGameTableViewFooterView alloc] initWithReuseIdentifier:identifier];
    }
