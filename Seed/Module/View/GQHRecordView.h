...
/**
 自定义根视图
 */
@interface GQHRecordView : GQHBaseView
...
/**
 列表视图的自定义行视图
 */
@interface GQHRecordTableViewCell : UITableViewCell
...
/**
 列表视图的自定义头视图
 */
@interface GQHRecordTableViewHeaderView : UITableViewHeaderFooterView
...
/**
 列表视图的自定义尾视图
 */
@interface GQHRecordTableViewFooterView : UITableViewHeaderFooterView
