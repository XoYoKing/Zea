...
#import "GQHLaunchView.h"
#import "GQHHeader.h"


#pragma mark -

@interface GQHLaunchView ()

@end

@implementation GQHLaunchView
...
@interface GQHLaunchTableViewCell ()

@end

@implementation GQHLaunchTableViewCell
...
+ (instancetype)qh_tableView:(UITableView *)tableView cellWithData:(id)data {
    ...
    static NSString *identifier = @"GQHLaunchTableViewCell";
    GQHLaunchTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        
        cell = [[GQHLaunchTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
...
@interface GQHLaunchTableViewHeaderView ()

@end

@implementation GQHLaunchTableViewHeaderView
...
+ (instancetype)qh_tableView:(UITableView *)tableView headerViewWithData:(id)data {
    ...
    static NSString *identifier = @"GQHLaunchTableViewHeaderView";
    GQHLaunchTableViewHeaderView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:identifier];
    if (!headerView) {
        
        headerView = [[GQHLaunchTableViewHeaderView alloc] initWithReuseIdentifier:identifier];
    }
...
@interface GQHLaunchTableViewFooterView ()

@end

@implementation GQHLaunchTableViewFooterView
...
+ (instancetype)qh_tableView:(UITableView *)tableView footerViewWithData:(id)data {
    ...
    static NSString *identifier = @"GQHLaunchTableViewFooterView";
    GQHLaunchTableViewFooterView *footerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:identifier];
    if (!footerView) {
        
        footerView = [[GQHLaunchTableViewFooterView alloc] initWithReuseIdentifier:identifier];
    }
