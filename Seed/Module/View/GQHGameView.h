...
/**
 列表视图的自定义行视图
 */
@interface GQHGameTableViewCell : UITableViewCell
...
/**
 列表视图的自定义头视图
 */
@interface GQHGameTableViewHeaderView : UITableViewHeaderFooterView
...
/**
 列表视图的自定义尾视图
 */
@interface GQHGameTableViewFooterView : UITableViewHeaderFooterView
