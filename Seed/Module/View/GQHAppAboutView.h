...
/**
 自定义视图的代理
 */
@protocol GQHAppAboutViewDelegate <NSObject>
...
/**
 自定义根视图
 */
@interface GQHAppAboutView : GQHBaseView

/**
 视图代理
 */
@property (nonatomic, weak) id<GQHAppAboutViewDelegate> qh_delegate;
...
/**
 列表视图的自定义行视图
 */
@interface GQHAppAboutTableViewCell : UITableViewCell
...
/**
 列表视图的自定义头视图
 */
@interface GQHAppAboutTableViewHeaderView : UITableViewHeaderFooterView
...
/**
 列表视图的自定义尾视图
 */
@interface GQHAppAboutTableViewFooterView : UITableViewHeaderFooterView
