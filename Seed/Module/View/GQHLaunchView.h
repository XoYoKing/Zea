...
/**
 自定义视图的代理
 */
@protocol GQHLaunchViewDelegate <NSObject>
...
/**
 自定义根视图
 */
@interface GQHLaunchView : GQHBaseView

/**
 视图代理
 */
@property (nonatomic, weak) id<GQHLaunchViewDelegate> qh_delegate;
...
/**
 列表视图的自定义行视图
 */
@interface GQHLaunchTableViewCell : UITableViewCell
...
/**
 列表视图的自定义头视图
 */
@interface GQHLaunchTableViewHeaderView : UITableViewHeaderFooterView
...
/**
 列表视图的自定义尾视图
 */
@interface GQHLaunchTableViewFooterView : UITableViewHeaderFooterView
