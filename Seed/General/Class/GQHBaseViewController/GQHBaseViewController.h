...
/**
 ...
 @param result 任意值
 */
typedef void (^GQHCustomBlock)(id result);
...
/**
 ...
 @param string 字符串
 */
typedef void (^GQHCustomStringBlock)(NSString *string);
...
/**
 ...
 @param array 数组
 */
typedef void (^GQHCustomArrayBlock)(NSArray *array);
...
/**
 ...
 @param dictionary 字典
 */
typedef void (^GQHCustomDictionarybBlock)(NSDictionary *dictionary);
