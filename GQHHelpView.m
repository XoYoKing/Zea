...
@interface GQHHelpView ()

@end

@implementation GQHHelpView
...
@interface GQHHelpTableViewCell ()

@end

@implementation GQHHelpTableViewCell
...
+ (instancetype)qh_tableView:(UITableView *)tableView cellWithData:(id)data {
    ...
    static NSString *identifier = @"GQHHelpTableViewCell";
    GQHHelpTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        
        cell = [[GQHHelpTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
...
@interface GQHHelpTableViewHeaderView ()

@end

@implementation GQHHelpTableViewHeaderView
...
+ (instancetype)qh_tableView:(UITableView *)tableView headerViewWithData:(id)data {
    ...
    static NSString *identifier = @"GQHHelpTableViewHeaderView";
    GQHHelpTableViewHeaderView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:identifier];
    if (!headerView) {
        
        headerView = [[GQHHelpTableViewHeaderView alloc] initWithReuseIdentifier:identifier];
    }
...
@interface GQHHelpTableViewFooterView ()

@end

@implementation GQHHelpTableViewFooterView
...
+ (instancetype)qh_tableView:(UITableView *)tableView footerViewWithData:(id)data {
    ...
    static NSString *identifier = @"GQHHelpTableViewFooterView";
    GQHHelpTableViewFooterView *footerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:identifier];
    if (!footerView) {
        
        footerView = [[GQHHelpTableViewFooterView alloc] initWithReuseIdentifier:identifier];
    }
